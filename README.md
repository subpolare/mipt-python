...
| 2 | Бактерии | 30.10, 17:00 | [Блокнот]() и запись | [Блокнот]() | Условные конструкции `if`, `elif` и `else`, циклы `for` и `while` |
| 2 | Археи | 30.10, 17:50 | [Блокнот]() и запись | [Блокнот]() | Модули `random`, `math`, `numpy` и `seaborn` для работы с данными | 
| 3 | Бактерии | 1.11, 17:00 | [Блокнот]() и запись | [Блокнот]() | Массивы и работа с файлами  | 
| 3 | Археи | 1.11, 17:50 | [Блокнот]() и запись | [Блокнот]() | Модули `matplotlib` и `seaborn` для визуализации данных | 
