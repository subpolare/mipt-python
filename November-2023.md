...
| 1 | Археи | 29.10, 12:05 | [Блокнот](https://colab.research.google.com/drive/1pcX2ZYo3Mbg4wlXDRWXqS69o1Q5aSkMI?usp=sharing) | Запись | [Блокнот]() | Форматы CSV и FASTA, работа с файлами | 
...
| 2 | Археи | 30.10, 17:50 | [Блокнот]() | Запись | [Блокнот]() | Модули `random`, `math`, `numpy` и `pandas` | 
